...
Por los general en el aprendizaje de las Estadística se trabaja con datos en una sola dimensión (univariado), se revisan tanto indicadores como la representación gráfica de las variables una a una. En ocaciones se pasa a estudiar grupos de variables de manera bivariada. Para ello se construyen tablas cruzadas y se construye una gráfica de  las dos variables en un plano de tal forma que permite identificar relaciones entre ellas.  
