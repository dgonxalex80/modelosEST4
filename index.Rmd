...
En esta primera unidad empezaremos con los modelos clasificados como descriptivos : El análisis de componentes principales, análisis de correspondencia, análisis discriminante y posteriormente trataremos los modelo de regresión lineal y el modelo de regresión logistica.
