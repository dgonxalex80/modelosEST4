...
Para la variables contenidas en la base de datos `rotacion` de `paqueteMODELOS`, determine es pisible contruir dos variables (componentes principales) que permitan reducir un grupo de variables sin perder información.
