...
```{r, warning=FALSE, message=FALSE}
cat("Matriz de valores observados", "\n")
cat("\n")
...
```{r, warning=FALSE, message=FALSE}
cat("Matriz de valores esperados", "\n")
cat("\n")
...
```{r, warning=FALSE, message=FALSE}
cat("Suma total de discrepancias", "\n")
cat("\n")
...
```{r, warning=FALSE, message=FALSE}
cat("Matriz U obtenidad en la factorización de la matriz de discrepancias C", "\n")
cat("\n")
...
cat("Matriz V obtenida en la factorizacion de la matriz de discremancias", "\n")
cat("\n")
...
```{r, message=FALSE, warning=FALSE}
cat("Matriz de cooordenadas filas", "\n")
cat("\n")
...
```{r, message=FALSE, warning=FALSE}
cat("Matriz de coordenadas columas", "\n")
cat("\n")
