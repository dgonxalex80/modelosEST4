...
Los valores  $\bf{n_{i.}}$ represdentan el total marginal de la variable $\bf{A}$, mientras que $\bf{n_{.j}}$ representa el total por columnas que corresponden a la variable `B`. La suma de todos los valores $\bf{n_{ij}}$ es $\bf{n}$ 
